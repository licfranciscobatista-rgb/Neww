...
// GarboChess by Gary Linscott (c) 2011
...
function InitializeFromFen(fen) {
    ...
    g_enPassentSquare = -1;
    if (chunks[3] && chunks[3].indexOf('-') == -1) {
...
function FinishMoveLocalTesting(bestMove, value, timeTaken, ply) {
    if (bestMove != null && typeof postMessage === 'function') {
        MakeMove(bestMove);
